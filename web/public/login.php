<?php
session_start();
require_once '../config/database.php'; // Ganti path sesuai lokasi file db koneksi
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        $stmt->bind_result($id, $nickname, $hashed_password);
        $stmt->fetch();
...
<body>
    <div class="login-container">
        <header class="login-header">
            <h1 class="login-title">Login Pengunjung</h1>
