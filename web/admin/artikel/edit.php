    ...
    <div class="admin-container">
        ...
        <form method="POST" enctype="multipart/form-data" class="create-form">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" class="form-input" value="<?= htmlspecialchars($data['title']) ?>" maxlength="255" required>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if ($data['picture']): ?>
                    <div class="current-image">
                        ...
                        <img src="../../assets/images/<?= $data['picture'] ?>" alt="Current image">
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" id="date" name="date" class="form-input" value="<?= $data['date'] ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="editor" class="form-editor" contenteditable="true" placeholder="Tulis isi artikel di sini..."><?= $data['content'] ?></div>
                <textarea id="content" name="content" class="form-textarea-hidden" required><?= htmlspecialchars($data['content']) ?></textarea>
            </div>
