...
<body>
    <div class="admin-container">
        <header class="admin-header">
            <h1 class="admin-title">Edit Penulis</h1>
        </header>

        <form method="POST" class="edit-form">
            <div class="form-group">
                <label class="form-label" for="nickname">Nama Penulis <span class="required">*</span></label>
                <input type="text" id="nickname" name="nickname" class="form-input" maxlength="100" required 
                       value="<?= htmlspecialchars($data['nickname']) ?>" placeholder="Masukkan nama penulis">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-input" maxlength="255" required 
                       value="<?= htmlspecialchars($data['email']) ?>" placeholder="contoh@email.com">
            ...
            <div class="form-group">
                ...
                <div class="form-help">Password minimal 6 karakter. Kosongkan jika tidak ingin mengubah password saat ini</div>
